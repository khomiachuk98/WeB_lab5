...
function getFreeSpace(a,b,c) {
	...
	v = parseInt(a/c, 10); //кол-во квадратов на стороне а
	h = parseInt(b/c, 10); //кол-во квадратов на стороне b
	res = v*h; //кол-во всех квадратов на прямоугольнике
	all_Squares = a*b; //площадь прямоугольника
	filled_space = res*c*c; //площадь занятая квадратами
	freeSpace = all_Squares - filled_space;
	
	return freeSpace; //свободная площадь
}
